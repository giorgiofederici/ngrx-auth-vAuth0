...
// To transform Node-style callback functions into observables
...
export class AuthService {
  ...
  // parseHash function, which will parse the access token from the window hash fragment. We'll use this during LoginComplete
  parseHash$ = bindNodeCallback(this._Auth0.parseHash.bind(this._Auth0));

  // Create observable of Auth0 checkSession method to
  // verify authorization server session and renew tokens
  // checkSession function, which we'll use when the app refreshes during CheckLogin
